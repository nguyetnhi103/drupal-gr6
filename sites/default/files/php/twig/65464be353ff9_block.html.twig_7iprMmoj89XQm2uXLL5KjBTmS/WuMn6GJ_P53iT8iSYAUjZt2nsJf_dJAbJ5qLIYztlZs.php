...
/* @rover/block/block.html.twig */
class __TwigTemplate_add9fdab56239722e9371070dd8cf457 extends Template
{
    private $source;
    private $macros = [];
...
($context["plugin_id"] ?? null), 35, $this->source)))];
    ...
    ";
        ...
        if (($context["label"] ?? null)) {
            // line 41
            echo "    <h2";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["title_attributes"] ?? null), "addClass", [0 => "block-title"], "method", false, false, true, 41), 41, $this->source), "html", null, true);
            echo ">";
...
";
    ...
    {
        return new Source("", "@rover/block/block.html.twig", "D:\\Study\\App\\xampp\\htdocs\\drupal\\themes\\contrib\\rover\\templates\\block\\block.html.twig");
    }
